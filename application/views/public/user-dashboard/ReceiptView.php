			...
			<td colspan="2">
				<table style="width: 100%; " cellpadding="0" cellspacing="0">
					...
					<tr>
						...
						<td colspan="2">&nbsp;</td>
						<td valign="top" align="right" style="font-size: 14px; line-height: 19px; padding: 15px;"><?=$order_main_detail->order_sub_detail[0]->fac_detail[0]->fac_google_address;?> - <?=$order_main_detail->order_sub_detail[0]->fac_detail[0]->fac_pincode;?><br> 
							<br> 
						</td>
					</tr>
						...
						<td colspan="4">
							<table cellspacing="0" cellpadding="0" width="100%" style="font-size: 14px">
								<tr>
									...
									<td align="center" class="bgback" style=" padding:10px;background:#efeeee; color:#000; font-weight: bold; width: 25% "><?php if($order_main_detail->booking_for=='facility'){ echo "Facility Name"; } else {echo "Academy Name";} ?></td>
									<td class="bgback" align="right"  style=" padding:10px;background:#efeeee; color:#000; font-weight: bold;width: 15% ">Sport</td>
									<td class="bgback" align="right"  style=" padding:10px;background:#efeeee; color:#000; font-weight: bold;width: 18% ">Booking Date</td>
									<td align="center" class="bgback"  style=" padding:10px;background:#efeeee; color:#000; font-weight: bold; width: 24% "><?php if($order_main_detail->booking_for=='facility'){ echo "Slot"; } else {echo "Batch";} ?></td>
									<?php if($order_main_detail->booking_for=='academy'){ ?>
									<td align="right" class="bgback" style=" padding:10px;background:#efeeee; color:#000; font-weight: bold; width: 25% ">Package</td>
									<?php } ?>
					...
					<?php
					 ...
					 $i=0; foreach ($order_main_detail->order_sub_detail as $order_sub_detail) {
						$i++; 

						//print_r($order_sub_detail->fac_detail);
						//echo $order_sub_detail->fac_detail[0]->fac_name;
						?>
						...
						<td colspan="4">
							<table cellspacing="0" cellpadding="0" width="100%" style="font-size: 14px">
								<tr>
									...
									<td align="center" class="bgback" style=" padding:10px; color:#000; width: 7%; border-bottom: 1px solid #ece7e7;"><?=$i;?></td>
									<td align="center" class="bgback" style=" padding:10px; color:#000; width: 25%; border-bottom: 1px solid #ece7e7; "><?=$order_sub_detail->fac_detail[0]->fac_name?></td>
									<td align="center" class="bgback"  style=" padding:10px; color:#000; width: 15%; border-bottom: 1px solid #ece7e7; "> <?=$order_sub_detail->sport_name[0]->sport_name;?></td>
									<td class="bgback" align="center"  style=" padding:10px; color:#000; width: 15%; border-bottom: 1px solid #ece7e7; "><?=date('d-m-Y', strtotime($order_sub_detail->start_date));?></td>
									<td align="center" class="bgback"  style=" padding:10px;; color:#000; width: 20%; border-bottom: 1px solid #ece7e7;"><?=$order_sub_detail->batch_slot_start_time.' - '.$order_sub_detail->batch_slot_end_time;?></td>
										<?php if($order_main_detail->booking_for=='academy'){  ?>
									<td align="right" class="bgback"  style=" padding:10px; color:#000;  text-align: center; width: 10%; border-bottom: 1px solid #ece7e7; "><?=$order_sub_detail->package_name;?></td>
									<?php } ?>
			...
			<tr>
				...
				<tr>
					<td colspan="2" style="padding-top:40px; font-size: 14px">
						<strong>
						Note: </strong>All Values have been rounded off to the nearest value.
						<br>
