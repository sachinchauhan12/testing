  ...
  <div class="tab-pane fade show active" id="academyfacilityuserbooking" role="tabpanel">
									...
									<?php
									 if(isset($get_booking_order) && !empty($get_booking_order)){foreach($get_booking_order as $bookingorderkey=>$bookingorderval){
										// echo "<pre>";
										// print_r($bookingorderval->get_slot_detail);
											...
											$data['get_facility']=$this->CommonMdl->getResultByCond('tbl_facility',array('fac_id'=>$get_booking_order[$bookingorderkey]->get_slot_detail[0]->fac_id),'fac_city,fac_name,fac_slug,fac_id,fac_banner_image',$order_by='');
											   foreach($data['get_facility'] as $facility){
													...
													<div class="item_data">
													   ...
													   (<?php echo $bookingorderval->sport_listing[0]->sport_name;?>)</span>
												   ...
												   <?php foreach($get_booking_order[$bookingorderkey]->get_slot_detail as $booking_slotkey=>$booking_slotval){ ?>
														...
														<span class="icone  d-inline-block ml-2 time"><i class="fa fa-clock-o" aria-hidden="true"></i>
														<?=$booking_slotval->batch_slot_start_time;?>  to <?=$booking_slotval->batch_slot_end_time;?> 
													...
													<div class="col-sm-6 text-right nopadright failedstatus " > Online
													...
													<br>
													 Order Status:<span class="<?php if($bookingorderval->booking_status=='confirm') echo "green"; else echo "red";?>"> <?php  echo ucwords($bookingorderval->booking_status);?></span>
													</div>	
									     ...
									     <ul class="list-unstyled list_items_dashboard user_booking_event">
											 ...
											 <li>
												<div class="booking_data clearfix">
													...
													<div class="item_data">
														<div class="col-sm-12 nopadleft">
														    <a data-toggle="modal" data-target="#eventdetaillistusers" class="booking_event title_dash">Booking ID : <?php  echo $bookingorderval->booking_order_no;?> <input type="hidden" id="booking_order_id" value="<?=$bookingorderval->booking_order_id;?>"></a>
													    </div>
														...
														</i>&nbsp;<?php echo $bookingorderval->event_listing[0]->event_venue;?>,&nbsp;<?php echo $bookingorderval->event_listing[0]->event_city;?> 
                                                      </span>
														<span class="icone date d-inline-block">
                                                        <i class="fa fa-calendar"></i>
  ...
  $(document).on("click", ".review_btn", function(){
	...
	$(document).ready(function(){
	   ...
	   if(rating == 0){
		...
		$(document).ready(function(){
			$(document).on("click", ".title_dash", function(){
