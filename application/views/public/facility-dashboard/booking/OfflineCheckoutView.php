	...
	<select class="form-control countrycode" value="" style="min-height:38px;">
		...
		<option data-countryCode="NP" value="977">+977</option> -->
					...
					<span id="errPhone" class="error"> </span>
								...
								<div class="col-md-6">
									<div class="form-group bmd-form-group is-filled" style="margin-top: 5px;">
										<label for="payment_type" class="bmd-label-floating">Payment Mode</label>
										<select class="form-control" id="payment_type">
											...
											<option class="abc" value="credit card"> credit card </option>
													...
													<tbody>
														...
														<tr>
															<td colspan="5" style="position: relative;">
																<span class="error" id="errCart"></span>
															</td>
														...
														<tr > 
															...
															<td colspan="5" >
															  ...
															  <img id="load_icon" src="<?php echo base_url('assets/');?>image/loading_icon.gif" class="menu-icon" /><br>	
																<button   class="paymentbooknow btn btn-default btn-block outline__btn orange-btn gapbtn " id= "paymentbooknow"  href="JavaScript:Void(0)"><i class="fa fa-arrow-right"></i> Book Now<div class="ripple-container"></div><div class="ripple-container"></div></button>
...
// $('#paymentbooknow').click(function(e) {
	$(document).on('click','#paymentbooknow',function(){
...
if(total_amount == 0){
$('#errCart').show();
	$('#errCart').html('No batch in the cart. <a href="https://vibestest.com/wip_projects/development/socialsportz-dev/dashboard">GO TO DASHBOARD</a>');
	$('html,body').animate({scrollTop: $("#errCart").offset().top - 190},'slow');
	return false;
}else{
	$('#errCart').html(''); 
}
