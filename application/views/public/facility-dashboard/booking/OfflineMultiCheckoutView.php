												...
												<table style="width:100%;">
													<tbody>
														...
														<tr>    
															...
															<td style="position: relative;" class="total-font text-right total1" colspan="3" id="total1"><i class="fa fa-inr"></i> <?=$total_price;?></td>
...
if(total_amount == 0){
$('#errCart').show();
	$('#errCart').html('No slot in the cart. <a href="https://vibestest.com/wip_projects/development/socialsportz-dev/dashboard">GO TO DASHBOARD</a>');
